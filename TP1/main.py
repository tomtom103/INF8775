...
if __name__ == "__main__":
    ...
    for i in range(4, 11):
        ...
        strassen_t = timeit.timeit('strassen_multiply(A, B)', globals=globals(), number=num_exec)
        strassen_leaf_t = timeit.timeit('strassen_multiply_leaf(A, B, 32)', globals=globals(), number=num_exec)
